...
\begin{abstract}
    This paper analyzes income and consumption inequality in Taiwan from 1981 to 2023 using household-level data from the Survey of Family Income and Expenditure. Income inequality has risen steadily but remains modest relative to other economies, with the burden falling most heavily on low-income households during recessions. Government redistribution through taxation and welfare programs has played a stabilizing role, though its effectiveness varies across crises. Consumption inequality has remained stable or declined, reflecting the role of savings, borrowing, and family support, as well as slower consumption growth among wealthier households. Together, these patterns highlight a divergence between income and consumption dynamics and signal potential structural vulnerabilities in Taiwan's economic landscape.
\end{abstract}
...
The top left variance and the bottom left P50-P10 ratio track each other extremely closely, both spiking around the 2000 Dot-com bubble and remaining relatively steady after that.
...
The Gini coefficient for household earnings in Taiwan has increased only 7 log points during the past four decades, while Heathcote, Perri, \& Violante (\citeyear{HEATHCOTE_2010}) showed that in the US, the Gini coefficient for household earnings has increased roughly 30 log points from 1967 to 2006.
...
These consumption phenomena could negatively impact Taiwan's economy, suggested by Hong (\citeyear{TW_consumption_inequality}), since wealthy families do not increase their consumption and lower-income families face higher housing and health insurance burdens. Eventually, this led to a stagnation of Taiwan's economy.
